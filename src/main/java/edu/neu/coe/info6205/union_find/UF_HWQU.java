...
public class UF_HWQU implements UF {
    ...
    public static int count(int n) {
    	UF_HWQU cal = new UF_HWQU(n);
    	int conNumber =0;
    	Random ran= new Random();
    	while(cal.count != 1) {
    		int p=ran.nextInt(n);
    		int q=ran.nextInt(n);
    		if(! cal.connected(p,q)) {
    			cal.union(p, q);
    		}
    		conNumber++;
    	}
    ...
    public static void findTest(int n) {
    ...
    public static void findTest1(int n) {
        Integer[] xs = new Integer[n];
        UF_HWQUPC pc = new UF_HWQUPC(n);
        Benchmark_Timer a=new Benchmark_Timer<>(
                "HWQUPC with Size",
                t -> {
                	pc.count(n);
    ...
    public static void findTest2 (int n) {
        Integer[] xs = new Integer[n];
        UF_HWQUPC1 pc = new UF_HWQUPC1 (n);
        Benchmark_Timer a=new Benchmark_Timer<>(
                "HWQUPC with height",
                t -> {
                	pc.count(n);
